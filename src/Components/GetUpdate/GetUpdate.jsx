        ...
        <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center md:w-2/3 lg:w-1/2 xl:w-1/3 md:text-left">
            <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">
              Stay <span className="text-[#7224b2] border-b-2 border-[#7224b2]">Updated</span> with Our Latest News!
            </h2>
            ...
            <form action="#" method="POST" className="mt-8 lg:mt-12">
              <div className="flex flex-col items-center sm:flex-row sm:justify-center">
                ...
                <button
                  type="submit"
                  className="inline-flex items-center justify-center flex-shrink-0 w-auto px-4 py-4 mt-4 font-semibold text-white transition-all duration-200 bg-[#7224b2] border border-transparent rounded-md sm:mt-0 sm:rounded-l-none sm:w-auto hover:bg-[#6515a7] "
                >
                  Get All Update
                </button>
              </div>
