  ...
  return (
    <label className="inline-flex items-center relative">
      <input
        ...
        type="checkbox"
      />
      <div className="relative w-[90px] h-[40px] bg-white peer-checked:bg-zinc-500/15 rounded-full after:absolute after:content-[''] after:w-[30px] after:h-[30px] after:bg-gradient-to-r from-orange-500 to-yellow-400 peer-checked:after:from-zinc-900 peer-checked:after:to-zinc-900 after:rounded-full after:top-[5px] after:left-[10px] active:after:w-[50px] peer-checked:after:left-[80px] peer-checked:after:translate-x-[-100%] shadow-sm duration-300 after:duration-300 after:shadow-md"></div>
      <svg
        height="0"
        width="100"
        viewBox="0 0 24 24"
